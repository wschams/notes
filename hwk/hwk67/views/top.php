...
<body>
    ...
    <div class="jumbotron">
        <div class="container text-center">
            ...
            <div>
                <br/>
                    <a href="index.php?action=home<?php if(!empty($zip)) echo "&zip=$zip" ?><?php if(!empty($min)) echo "&min=$min" ?><?php if(!empty($max)) echo "&max=$max" ?><?php echo "&page=" . $page = $page-1 ?>">Previous</a>
                    <a href="<?php getLink(["page"=>$page+1]) ?>">Next</a>
            </div>
        </div>
    </div>
    <div class="container">