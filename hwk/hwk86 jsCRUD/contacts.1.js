//JSON from database part however not neccesary because I copied this file into the other part of hwk
/*global $*/
(function () {
    "use strict";
    ...
    function addJsonContacts() {

        $.get("contacts.php", function (loadedData) {
            JSON.parse(loadedData).forEach(function (element) {
                addContact(element);
            });
