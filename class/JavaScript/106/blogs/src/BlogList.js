...
export default class BlogList extends Component {
    ...
    renderBlogs() {
        const blogs = this.state.blogs.map(blog => <li key={blog.id}><BlogInfo blog={blog} blogSelected={this.blogSelected} /></li>)
        const selectedBlog = this.state.selectedBlog ? <Blog blog={this.state.selectedBlog} /> : null;
